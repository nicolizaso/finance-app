...
const CreditCardWidget = ({ isPrivacyMode, refreshTrigger }) => {
  ...
  return (
    <div className="bento-card flex flex-col justify-between h-full relative overflow-hidden group">
      ...
      <div className="grid grid-cols-2 gap-4 z-10">
        {/* Total Debt */}
        <div className="bg-slate-700/30 p-4 rounded-2xl border border-transparent hover:border-indigo-500/20 transition-colors">
        ...
        <div className="bg-slate-700/30 p-4 rounded-2xl border border-transparent hover:border-indigo-500/20 transition-colors">
            <div className="flex items-center gap-1 mb-1">
                 ...
                 <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">Próx. Resumen</p>
            </div>
